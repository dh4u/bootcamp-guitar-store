...
export function Inventory (index, shortName, longName, description, price, image, quantityInStock) {
    this.index = index;
...
export function initializeInventory() {
    let i = 0
        ...
        ,description = ""
        ;
    // console.log(localStorage.getItem("inventoryInitialized"));
    ...
    if (localStorage.getItem("inventoryInitialized") === null) {
        ...
        description = '<p>For guitarists everywhere who appreciate great style, rich and versatile tone, and excellent value, the Standard Stratocaster is an elegant and affordable classic with a great combination of traditional design and contemporary features. Time-honored Fender style and performance-minded modern upgrades don\'t have to break the bank, and this model delivers the best of both in an instrument ideal for Stratocaster players everywhere at every level. This model comes in a limited edition Sea Foam Pearl. Case sold separately.</p><div> <h6>Features</h6> <strong>Body</strong> <ul style="text-align: left"> <li>Body shape: Double cutaway</li><li>Body type: Solid body</li><li>Body material: Solid wood</li><li>Top wood: Not applicable</li><li>Body wood: Alder</li><li>Body finish: Gloss Polyester</li><li>Orientation: Right handed</li></ul> <strong>Neck</strong> <ul style="text-align: left"> <li>Neck shape: C</li><li>Neck wood: Maple</li><li>Joint: Bolt-on</li><li>Scale length: 25.5 in.</li><li>Truss rod: Standard</li><li>Neck finish: Satin Urethane</li></ul> <strong>Fretboard</strong> <ul style="text-align: left"> <li>Material: Maple</li><li>Radius: 9.5 in.</li><li>Fret size: Medium jumbo</li><li>Number of frets: 21</li><li>Inlays: Dot</li><li>Nut width: 1.65 in. (42 mm)</li></ul> <strong>Pickups</strong> <ul style="text-align: left"> <li>Configuration: SSS</li><li>Neck: Standard Single-Coil Strat</li><li>Middle: Standard Single-Coil Strat</li><li>Bridge: Standard Single-Coil Strat</li><li>Brand: Fender</li><li>Active or passive pickups: Passive</li><li>Series or parallel: Series</li><li>Piezo: No</li><li>Active EQ: No</li><li>Special electronics: None</li></ul> <strong>Controls</strong> <ul style="text-align: left"> <li>Control layout: Master volume, tone 1, tone 2</li><li>Pickup switch: 5-way</li><li>Coil tap or split: No</li><li>Kill switch: No</li></ul> <strong>Hardware</strong> <ul style="text-align: left"> <li>Bridge type: Tremolo/Vibrato</li><li>Bridge design: 6-saddle vintage-style syncronized tremolo</li><li>Tailpiece: Not applicable</li><li>Tuning machines: Standard cast</li><li>Color: Nickel/chrome</li></ul> <strong>Other</strong> <ul style="text-align: left"> <li>Number of strings: 6-string</li><li>Special features: Limited edition finish</li><li>Case: Sold separately</li><li>Accessories: None</li><li>Country of origin: Mexico</li></ul> </div></div></div>';
        ...
        description = '<p>Often copied, but never surpassed, the Stratocaster is arguably the world&rsquo;s most-loved electric guitar. Electrifying the music world since its debut in 1954, its natural, versatile sound made the Stratocaster the benchmark for exceptional guitar tones. The American Professional Stratocaster isn&rsquo;t a re-imagining of the classic design; it&rsquo;s the authentic original model, evolved.<br><br>The choice of musical legends since its release, the Stratocaster feel and sound set the world on fire, powering music movements from electric blues to EDM, and everything in-between. In your hands this Strat is ready to navigate the creative twists and turns of your music, inspiring you to express yourself in new ways through your playing.<br><br>Developed by pickup master Tim Shaw, the brand-new V-Mod single-coil pickups are voiced specifically for each position, mixing alnico magnet types to produce powerful, nuanced tones with original Fender sonic DNA. Retain high end clarity when adjusting the volume controls, thanks to the new treble-bleed tone circuit that lets your tone shine through in all its glory. The new modern &ldquo;Deep C&rdquo;-shaped neck profile feels just right in your hand while the narrow-tall frets make it easy to bend strings accurately and play perfectly intonated chords.<br><br>The best of yesterday and today, the American Professional Stratocaster is the latest form of electric inspiration from Fender. Step up and stake your claim to a legend.<br></p><div> <h6>Features</h6> <strong>Body</strong> <ul style="text-align: left"> <li>Body shape: Double cutaway</li><li>Body type: Solid body</li><li>Body material: Solid wood</li><li>Top wood: Not applicable</li><li>Body wood: Alder, Ash on Sienna Sunburst</li><li>Body finish: Gloss Polyurethane</li><li>Orientation: Right handed</li></ul> <strong>Neck</strong> <ul style="text-align: left"> <li>Neck shape: Modern Deep C</li><li>Neck wood: Maple</li><li>Joint: Bolt-on</li><li>Scale length: 25.5 in.</li><li>Truss rod: Dual-action</li><li>Neck finish: Satin</li></ul> <strong>Fretboard</strong> <ul style="text-align: left"> <li>Material: Rosewood</li><li>Radius: 9.5 in.</li><li>Fret size: Tall narrow</li><li>Number of frets: 22</li><li>Inlays: Dot</li><li>Nut width: 1.687 in. (42.8 mm)</li></ul> <strong>Pickups</strong> <ul style="text-align: left"> <li>Configuration: SSS</li><li>Neck: V-Mod Single-Coil Strat </li><li>Middle: V-Mod Single-Coil Strat </li><li>Bridge: V-Mod Single-Coil Strat </li><li>Brand: Fender</li><li>Active or passive pickups: Passive</li><li>Series or parallel: Series</li><li>Piezo: No</li><li>Active EQ: No</li><li>Special electronics: None</li></ul> <strong>Controls</strong> <ul style="text-align: left"> <li>Control layout: Master volume, tone 1, tone 2</li><li>Pickup switch: 5-way</li><li>Coil tap or split: No</li><li>Kill switch: No</li></ul> <strong>Hardware</strong> <ul style="text-align: left"> <li>Bridge type: Tremolo/Vibrato</li><li>Bridge design: 2-Point Synchronized Tremolo with Bent Steel Saddles and Pop-In Tremolo Arm </li><li>Tailpiece: Not applicable</li><li>Tuning machines: Deluxe staggered</li><li>Color: Nickel/chrome</li></ul> <strong>Other</strong> <ul style="text-align: left"> <li>Number of strings: 6-string</li><li>Special features: Electronics</li><li>Case: Hardshell case</li><li>Accessories: None</li><li>Country of origin: United States</li></ul> </div>';
